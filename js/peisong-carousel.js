/**
 * 配送首页（peisong.html）功能提示轮播，逻辑同 home-carousel.js
 */
(function () {
  'use strict';

  var track = document.getElementById('peisongCarouselTrack');
  var dotsRoot = document.getElementById('peisongCarouselDots');
  var prevBtn = document.getElementById('peisongCarouselPrev');
  var nextBtn = document.getElementById('peisongCarouselNext');
